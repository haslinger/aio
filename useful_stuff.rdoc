...
3. Bootstrap: <tt>rails g bootstrap:themed Resources
4. Abilty: <tt>models/abilty.rb</tt>
5. Translation: <tt>confilg/locales/en.yml</tt>
6. Menu: <tt>sidebars/process.html.erb</tt>
7. Controller
8. Model <tt>app/models/company.rb</tt>
...
not used for this app, but maybe handy:
...
=== More Generators
  rails generate migration create_functions_users #migration has to be written manually
  rails generate migration create_roles_in_company_users #migration has to be written manually
