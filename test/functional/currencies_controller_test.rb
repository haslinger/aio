...
class CurrenciesControllerTest < ActionController::TestCase
  ...
  test "should create currency" do
    assert_difference('Currency.count') do
      post :create, currency: { company_id: @currency.company_id, currency: @currency.currency, shorttext: @currency.shorttext }
    end
  ...
  test "should update currency" do
    put :update, id: @currency, currency: { company_id: @currency.company_id, currency: @currency.currency, shorttext: @currency.shorttext }
    assert_redirected_to currency_path(assigns(:currency))
  end
